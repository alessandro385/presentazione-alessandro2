...
export const LEVELS = [
  {
    ...
    boss: {
      nome: 'Grinch Esploratore', hp: 60, punti: 2000,
      dimensione: 55, colore: '#34d399', velocita: 80,
      fasi: [
        { sotto: 1.00, pattern: ['ventaglio'], cooldown: 2.4, velocitaMult: 1.0 },
        { sotto: 0.60, pattern: ['ventaglio', 'raffica'], cooldown: 2.0, velocitaMult: 1.25 },
        { sotto: 0.25, pattern: ['raffica', 'muro'], cooldown: 1.7, velocitaMult: 1.5 },
      ],
    },
  },
  {
    ...
    boss: {
      nome: 'Guardiano della Foresta', hp: 90, punti: 3000,
      dimensione: 60, colore: '#4ade80', velocita: 90,
      fasi: [
        { sotto: 1.00, pattern: ['ventaglio'], cooldown: 2.2, velocitaMult: 1.0 },
        { sotto: 0.65, pattern: ['raffica', 'ventaglio'], cooldown: 1.9, velocitaMult: 1.2 },
        { sotto: 0.30, pattern: ['muro', 'evocazione'], cooldown: 1.8, velocitaMult: 1.45 },
      ],
    },
  },
  {
    ...
    boss: {
      nome: 'Sindaco di Ghiaccio', hp: 125, punti: 4500,
      dimensione: 62, colore: '#a78bfa', velocita: 100,
      fasi: [
        { sotto: 1.00, pattern: ['raffica', 'ventaglio'], cooldown: 2.0, velocitaMult: 1.0 },
        { sotto: 0.66, pattern: ['muro', 'raffica'], cooldown: 1.8, velocitaMult: 1.25 },
        { sotto: 0.33, pattern: ['pioggia', 'muro'], cooldown: 1.7, velocitaMult: 1.5 },
      ],
    },
  },
  {
    ...
    eventi: [{ at: 0.5, tipo: 'pioggiaRegali' }],
    boss: {
      nome: 'Colosso delle Vette', hp: 165, punti: 6000,
      dimensione: 68, colore: '#38bdf8', velocita: 105,
      fasi: [
        { sotto: 1.00, pattern: ['ventaglio', 'muro'], cooldown: 1.9, velocitaMult: 1.0 },
        { sotto: 0.66, pattern: ['pioggia', 'raffica'], cooldown: 1.7, velocitaMult: 1.3 },
        { sotto: 0.33, pattern: ['muro', 'pioggia', 'evocazione'], cooldown: 1.6, velocitaMult: 1.55 },
      ],
    },
  },
  {
    ...
    boss: {
      nome: 'Il Grinch', hp: 220, punti: 10000,
      dimensione: 75, colore: '#84cc16', velocita: 115,
      fasi: [
        { sotto: 1.00, pattern: ['ventaglio', 'raffica'], cooldown: 1.8, velocitaMult: 1.0 },
        { sotto: 0.75, pattern: ['muro', 'evocazione'], cooldown: 1.7, velocitaMult: 1.2 },
        { sotto: 0.50, pattern: ['pioggia', 'raffica', 'muro'], cooldown: 1.55, velocitaMult: 1.4 },
        { sotto: 0.25, pattern: ['pioggia', 'muro', 'evocazione'], cooldown: 1.4, velocitaMult: 1.65 },
      ],
    },
  },
];
