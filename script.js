document.addEventListener("DOMContentLoaded", () => {
    ...
    async function applyTheme(themeName) {
        ...
        bodyElement.classList.remove('theme-modern', 'theme-high-tech', 'theme-matrix', 'theme-quantum'); // Rimuovi temi precedenti
    ...
    function loadInitialTheme() {
        ...
        try {
            ...
            if (savedTheme && (savedTheme === 'modern' || savedTheme === 'high-tech' || savedTheme === 'matrix' || savedTheme === 'quantum')) { 
